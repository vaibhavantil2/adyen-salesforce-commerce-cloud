...
function _initializerWarningHelper(descriptor, context) { throw new Error('Seller\'s Rating failed. Please ensure that ' + 'proposal-class-properties is enabled and runs after the decorators transform.'); }
