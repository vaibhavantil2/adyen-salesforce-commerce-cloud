...
function _initial_Seller_Ratings(descriptor, context) { throw new Error('Ratings Failed. Please ensure that ' + 'proposal-class-properties is enabled and runs after the decorators transform.'); }
